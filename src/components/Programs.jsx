...
export default function Programs() {
  const programs = [
    { 
      ...
      link: "/fitness-gym-site/program/iron-strength"
    },
    { 
      title: "Zen & Mobility", 
      ...
      link: "/fitness-gym-site/program/zen-mobility"
    },
    { 
      ...
      link: "/fitness-gym-site/program/endurance-earth"
    }
  ];
    ...
    <div className="bg-linear-to-b from-stone-50 via-white to-stone-50 py-32 px-8 text-stone-800 border-t border-stone-200/50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {programs.map((prog, index) => (
            <Link
              key={index}
              to={prog.link}
              className={`group relative overflow-hidden rounded-2xl transition-all duration-500 hover:-translate-y-2 cursor-pointer block`}
            ...
            >
              ...
              {/* Card Content */}
              <div className="relative bg-white border border-stone-200/60 p-10 rounded-2xl shadow-sm hover:shadow-xl transition-shadow duration-500 hover:border-emerald-300/30 group-hover:border-emerald-200 h-full">
                {/* Accent Bar */}
                ...
                {/* Learn More Link */}
                <div className="mt-6 inline-flex items-center gap-2 text-emerald-600 font-semibold opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  Learn More
        ...
        <div className="text-center mt-16">
          <a href="/fitness-gym-site/programs" className="group inline-flex items-center gap-2 bg-linear-to-r from-emerald-600 to-teal-600 text-white px-10 py-4 rounded-full font-semibold hover:shadow-xl hover:shadow-emerald-600/30 transition-all active:scale-95">
