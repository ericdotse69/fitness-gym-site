  ...
  return (
    <div className="bg-linear-to-b from-stone-50 via-white to-stone-50 py-32 px-8 text-stone-800 border-t border-stone-200/50">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-4">
          {classes.map((cls, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-linear-to-r ${cls.style} opacity-0 group-hover:opacity-10 transition-opacity duration-300 rounded-xl`}></div>
              ...
              <div className="relative bg-white/80 backdrop-blur border border-stone-200/60 rounded-xl p-6 hover:border-emerald-300/50 transition-all duration-300 hover:shadow-lg hover:bg-white">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center space-x-6 w-full md:w-auto">
                    <div className="shrink-0">
                      <div className={`w-16 h-16 rounded-lg bg-linear-to-br ${cls.style} flex items-center justify-center text-2xl transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-md`}>
                        {cls.icon}
                      </div>
                    </div>
                    <div>
                  ...
                  <div className="flex items-center justify-between w-full md:w-auto gap-4 md:gap-6">
                    ...
                    <div className={`shrink-0 text-xs font-bold uppercase tracking-wider py-2 px-4 rounded-full bg-linear-to-r ${cls.style} text-white shadow-md group-hover:shadow-lg transition-shadow transform group-hover:scale-105`}>
                      {cls.type}
                    </div>
                  </div>
                </div>
                ...
                {/* Bottom Accent Line */}
                <div className={`absolute bottom-0 left-0 h-1 w-0 bg-linear-to-r ${cls.style} group-hover:w-full transition-all duration-500 rounded-full`}></div>
              </div>
            </div>
          ))}
        </div>
        ...
        {/* CTA Section */}
        <div className="mt-20 bg-linear-to-r from-emerald-50 to-teal-50 border border-emerald-200/50 rounded-2xl p-10 md:p-14 text-center">
